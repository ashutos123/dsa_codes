...
// int main()
// {int n;
//     cout<<"enter the integer to find sum upto"<<endl;cin>>n;
//    cout<<"fdsfsdffwefcfsdfdsfsdfsdfsfsdfsdfsdsdfsfsdfsfdsfsdfdsfdfsdfdsfdsfsdffsdfdsfsdsdsdsdsdsdssfdsfdsfdsf"<<endl;
//    int a=8, b=34;
//    cout<<a+b<<endl;
//    int s=0;
//    for(int i=0;i<n;i++)
